...
public class Employee {
	...
	public Employee(int empId, String empName, String empNo, String email, String phone, Department deptCode,
			Job jobCode, Salary salLevel, int salary, double bonus, int managerId, Date hireDate, Date entDate,
			char entYn) {
		super();
		this.empId = empId;
	...
	public Salary getSalLevel() {
		return salLevel;
	}

	public void setSalLevel(Salary salLevel) {
		this.salLevel = salLevel;
	}
